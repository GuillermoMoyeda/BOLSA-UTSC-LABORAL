        ...
        return `
            <div class="postulacion-card" data-style="${colorIndex}">
                ...
                <div class="pc-actions">
                    <a href="/alumno-explorar?id=${v.id}" class="btn-card btn-card-go">Ver Vacante</a>
...
function loadSavedSidebar() {
    ...
    container.innerHTML = guardados.reverse().slice(0, 8).map(v => `
        <div class="saved-item-small" onclick="window.location.href='/alumno-explorar?id=${v.id}'">
