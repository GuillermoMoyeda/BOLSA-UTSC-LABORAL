...
function initChart(alumnos, empresas, admins) {
    ...
    // Si no hay datos, mostrar todo gris para evitar gráfico en blanco
    ...
    const dataLabels = isEmpty ? ['Sin datos aún'] : ['Alumnos', 'Empresas', 'Administradores'];
...
async function loadAdsCarousel() {
    try {
        ...
        console.error(err);
        document.getElementById('adsCarousel').innerHTML = '<div style="color:red; text-align:center; padding:2rem;">Error al cargar publicidad</div>';
    }
}
