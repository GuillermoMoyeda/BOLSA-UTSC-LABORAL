...
function renderEmpresas(empresas) {
    ...
    empresasTableBody.innerHTML = empresas.map(e => `
        <tr>
            <td data-label="ID" style="font-weight: 700; color: var(--color-primary);">#${e.id}</td>
            <td data-label="Empresa" style="font-weight: 600;">${e.nombreEmpresa}</td>
            <td data-label="Representante">${e.nombre || e.representante}</td>
            <td data-label="Correo">${e.correo}</td>
            <td data-label="UbicaciÃ³n">${e.ciudad || e.municipio}</td>
